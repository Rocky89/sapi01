...
public class AcceptanceTestTestUtil {
    ...
    public static AcceptanceTestDTO createFormObject(Long id, String description, String title) {
    ...
    public static AcceptanceTest createModel(Long id, String description, String title) {
