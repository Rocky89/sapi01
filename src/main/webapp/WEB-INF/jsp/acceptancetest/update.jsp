...
<body>
    <h1><spring:message code="label.acceptancetest.update.page.title"/></h1>
    <div class="well page-content">
        <form:form action="/acceptancetest/update" commandName="acceptancetest" method="POST" enctype="utf8">
            <form:hidden path="id"/>
            ...
            <div class="action-buttons">
                <a href="/acceptancetest/${acceptancetest.id}" class="btn"><spring:message code="label.cancel"/></a>
                <button id="update-story-button" type="submit" class="btn btn-primary"><spring:message
                        code="label.update.acceptancetest.button"/></button>
            </div>
        </form:form>
    </div>
</body>
